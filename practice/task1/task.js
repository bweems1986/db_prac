...
//
const query2 = "select title from movies where title like '%e' order by title asc";
//
...
//      Animation   |           968.5
//      Action      |         3853.27
const query3 = "select distinct genre,sum(boxoffice) as total_boxoffice from movies group by genre order by total_boxoffice";
//
